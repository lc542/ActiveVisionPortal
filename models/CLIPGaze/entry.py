...
def get_args_parser_train():
    ...
    parser.add_argument('--train_file_absent', default='coco_search18_fixations_TA_train.json', type=str,
                        help="Training fixation file")
    parser.add_argument('--bbox_file', default='datasets/COCO-Search18/bbox_annos.npy', type=str,
                        help="Training fixation file")
    parser.add_argument('--img_ftrs_dir', default='models/CLIPGaze/data/vit-L-14/featuremaps/',
