...
def get_args_parser_test():
    ...
    parser.add_argument('--trained_model', default='models/Gazeformer/checkpoints/gazeformer_cocosearch_TP.pkg', type=str, help="Trained model checkpoint to run for inference")
